...
*************************************************************/
function fynode_local_import_files() {
	return array(
		array(
...
add_filter( 'merlin_import_files', 'fynode_local_import_files' );

/************************************************************
## Setup Wizard After Import
*************************************************************/
function fynode_merlin_after_import_setup() {
    ...
    if ( class_exists( 'woocommerce' ) ) {
        ...
        update_option( 'woocommerce_shop_page_id', '31' );
        update_option( 'woocommerce_cart_page_id', '384' );
        update_option( 'woocommerce_checkout_page_id', '392' );
        update_option( 'woocommerce_myaccount_page_id', '34' );
    }


}
add_action( 'merlin_after_all_import', 'fynode_merlin_after_import_setup' );
