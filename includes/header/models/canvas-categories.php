...
if ( ! function_exists( 'fynode_header_canvas_categories' ) ) {
	function fynode_header_canvas_categories(){
		$canvascategories = get_theme_mod('fynode_header_sidebar','0');
		...
		<div class="site-drawer categories-drawer">
			<div class="site-drawer-inner">
				<div class="site-drawer-row site-drawer-header flex items-center justify-between">
					<h3 class="entry-title"><?php esc_html_e('All Categories','fynode'); ?></h3>
...
add_action('wp_footer', 'fynode_header_canvas_categories');