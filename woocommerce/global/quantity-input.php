...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'fynode' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'fynode' );
...
<div class="quantity bordered">
	...
	<input
		...
		aria-label="<?php esc_attr_e( 'Product quantity', 'fynode' ); ?>"
		size="4"
